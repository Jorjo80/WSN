...
void imprimirestado()
{
 	if(estado==2)
	{
		_WSN_Write_UART("AT+UCAST:0000=");
	 	_WSN_Write_UART("Plaza 3: La plaza esta ocupada\n\r");
	}
	if(estado==3)
	{	
		_WSN_Write_UART("AT+UCAST:0000=");
	 	_WSN_Write_UART("Plaza 3: La plaza esta libre\n\r");
	}
}
...
{ 	
	...
	{  
		...
		{			 
		 	...
		 	{
		 		_WSN_Write_UART("AT+UCAST:0000=");
				_WSN_Write_UART("Plaza 3 está libre\n\r");
		 	}
			RX_flag=0;
		}
		else if(RX_flag==5)
		{	
			if(estado==2)
		 	{
		 		_WSN_Write_UART("AT+UCAST:0000=");
				_WSN_Write_UART("Plaza 3 está ocupada\n\r");
		 	}
			RX_flag=0;
		}
		else
